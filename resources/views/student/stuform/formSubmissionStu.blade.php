...
<main>
    ...
    @if ($formSubmissions->isEmpty())
        {{-- <a href="" class="btn btn-primary">Add Submission</a> --}}
            ...
            <tr>
               ...
               <td>
                @if ($submissionDeadline->isFuture())
                    <span class="v-chip chip--label bg-light-green text-black">Pending</span>
                @else
                    <span class=" v-chip chip--label bg-light-red text-white">Overdue</span>
                @endif
               </td>
            </tr>
            <tr>
