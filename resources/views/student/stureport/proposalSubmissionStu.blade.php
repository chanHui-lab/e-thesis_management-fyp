...
<main>
    ...
    <h3 class="col-title">Proposal Submission Column</h3>
    @php
    ...
    <div class = "row row-buttonform" style="margin-left: 5px">
        <a href="{{ route('proposalSubmission.edit', ['proposalSubmissionId' => $proposalSubmission->id,'submissionPostId' => $submissionPost->id]) }}" class="btn btn-warning btn-common">
            <i class="fas fa-pencil-alt">
            </i>
            Edit Submission
        </a>

        <form action="{{ route('proposalSubmission.delete',$proposalSubmission->id) }}" method="POST">

        <button type="button" class="btn btn-danger btn-common" data-toggle="modal" data-target="#deleteModal{{ $proposalSubmission->id }}">
            <i class="fas fa-trash"></i>
            Delete Submission
        </button>
        <div class="modal fade" id="deleteModal{{ $proposalSubmission->id }}" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true">
    ...
    @else
        <a href="{{ route('stuProposalSubmission.create',['submission_post_id' =>  $submissionPost->id]) }}" class="btn btn-primary btn-common"><i class="fas fa-plus"></i> Add Submission</a>
    @endif
    ...
    <div class = "card" style="margin-top: 16px">
        ...
        @if ($proposalSubmission)
            ...
            @php
                $thesisFile = json_decode($proposalSubmission->proposal_file, true);
                ...
                $proposalType = explode(',', $proposalSubmission->proposal_type);
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $proposalSubmission->proposal_title }}</td>
                </tr>
                <tr>
                    <th>Abstract:</th>
                ...
                <tr>
                    <th><strong>Proposal File</strong></th>
                    <td>
                        ...
                        <ul id="comments-container">
                            ...
                            <div class="card direct-chat direct-chat-primary">
                                ...
                                <div class="card-footer">
                                    <form method="POST" action="{{ route('stuProposalSubmission.addComment', ['proposalSubmissionId' => $proposalSubmission->id]) }}">
                                        @csrf
