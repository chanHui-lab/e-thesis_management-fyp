...
<main>
    <div class="form-section" style="display: flex; align-items: center; ">
        <i class="fa fa-file-powerpoint" style="font-size: 30px; margin-right:15px"></i>
        <h1 style="padding-top: 1%">Presentation Slide Section</h1>
    </div>
        ...
        <div class="col-md-12">
            <div class="card"  style="z-index:10;margin-top:20px; margin-left: -15px; margin-bottom:30px;">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h3>Presentation Slides Template</h3>
                </div>
                {{-- end card header --}}
    ...
    <div class="row" style="margin-left: 0%">
        <div class="col-md-12">
            <div class="card"  style="margin-top:5px; padding:0px; margin-left: -15px;">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h3>Presentation Slides Submission</h3>
                </div>
                {{-- end card header --}}
                ...
                <div class="card-body">
                    ...
                    <div class="file-container eachSubRow">
                        <h2 class="file-link"><i class="fa fa-solid fa-file-import"  style="margin-right: 10px; color: rgb(64, 31, 1);"></i>
                            <a class="brown-link" style="font-size: 14px" href="{{ route('stuSlideSubmission.details', ['submissionPostId' => $postform['submissionPost']->id]) }}">
