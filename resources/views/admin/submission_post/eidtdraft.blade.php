                        ...
                        <ul>
                            @foreach ($files as $file)
                                <li>
                                    ...
                                    {{-- <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#confirmationModal{{ $file }}"> --}}
...
function addFileInput(element) {
  console.log('addFileInput file loaded');
    ...
    function removeFile(modalID, postID, filePath) {
        ...
        $.ajax({
            url: `/admin/formsubmissionpage/remove/${postID}`,
            type: 'DELETE',
            headers: {
            ...
            success: function (data) {
                if (data.message) {
                    ...
                    successMessage.text('File removed successfully');
        ...
        error: function (error) {
            // Log the error and handle network errors
