...
<main>
    ...
    <h1><i class="fas fa-user-graduate" style="font-size: 35px; margin-right:20px;"></i>Assign Advisors to Students</h1>
    ...
    <form action="{{ route('advisor-assignment.store') }}" method="POST">
        ...
        <div class="form-group">
            <label for="stu_id">Select a Student:</label>
            <select name="stu_id" id="stu_id" class="form-control">
                @foreach ($students as $student)
                    <option value="{{ $student->stu_id }}">
                        {{ $student->matric_number }} - {{ $student->user->name }}
                    </option>
        ...
        <button class="btn btn-success rounded-btn btn-common" type="submit">Assign Advisor</button>
    </form>
