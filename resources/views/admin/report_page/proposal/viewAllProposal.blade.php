...
<main>
    <div class="row">
        <div style = "padding-top: 20px;" class="col-lg-12">
            <a class="btn btn-primary back-button" href="{{ route('proposalpost.index') }}">Back</a>
                ...
                <div class="card-body">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{ $proposalSubmission ? route('proposalpost.show', ['submissionPostId' => $submissionPost->id, 'proposalSubmissionId' => $proposalSubmission->id]) : '#' }}" class="btn btn-primary {{ !$proposalSubmission ? 'btn-disabled grey-btn' : '' }}" @if (!$proposalSubmission) disabled @endif>
