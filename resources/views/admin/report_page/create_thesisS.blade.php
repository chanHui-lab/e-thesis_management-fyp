...
<main>
    ...
    <a href="{{ route('thesispost.index') }}" style = "margin-bottom:20px" class="btn btn-primary">Back</a>
    ...
    <div class="card card-primary">
        ...
        <form method="post" action="{{ route('thesispost.store')}}" enctype="multipart/form-data">
