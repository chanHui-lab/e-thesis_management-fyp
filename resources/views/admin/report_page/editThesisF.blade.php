...
<a style = "margin-bottom: 20px;" class="btn btn-primary" href="{{ route('thesispost.index') }}"> Back</a>
 {{--handle error  --}}
@if ($errors->any())
...
<div class="card card-primary">
    ...
    <!-- form start -->
      ...
      <form method="POST" action="{{ route('thesispost.update', ['id' => $getRecord->id]) }}" enctype="multipart/form-data">
