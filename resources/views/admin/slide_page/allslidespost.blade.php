    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="float-right" style = "padding-bottom: 10px;">
                <a class="btn btn-success rounded-btn btn-common" href="{{ route('slidespost.create') }}">
                    <i class="fa fa-upload" style="margin-right: 5px;"></i> Upload New Slides Submission Post</a>
            </div>
        </div>
    </div>
                ...
                <tr>
                    ...
                    <td>
                        <form action="{{ route('formpost.destroy',$postform->id) }}" method="POST">
                            ...
                            <a class="btn btn-primary btn-sm rounded-btn" href="{{ route('slidespost.showAll', ['submissionPostId' => $postform->id]) }}">
                            ...
                            <a class="btn btn-info btn-sm rounded-btn" href="{{ route('slidespost.edit',$postform->id) }}">
