...
{{-- TO CREATE  --}}
<main>
    <h1 style = "padding-top: 20px; padding-bottom:20px">Create Presentation Slide Submission Post</h1>
    ...
    <a href="{{ route('slidespost.index') }}" style = "margin-bottom:20px" class="btn btn-primary">Back</a>
    ...
    <div class="card card-primary">
        ...
        <form method="post" action="{{ route('formpost.store')}}" enctype="multipart/form-data">
