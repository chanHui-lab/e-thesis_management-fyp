    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="float-right">
                <a style="margin-bottom: 10px;" class="btn btn-success btn-common" href="{{ route('slidestemplate.create') }}">
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="{{ route('template.destroy',$templateform->id) }}" method="POST">
                             ...
                             <a class="btn btn-info btn-sm rounded-btn" href="{{ route('slidestemplate.edit',$templateform->id) }}">
