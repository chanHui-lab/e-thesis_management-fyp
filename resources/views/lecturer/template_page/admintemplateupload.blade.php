    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="float-right">
                ...
                @endphp
                <a style="margin-bottom: 10px;" class="btn btn-success btn-common" href="{{ route('lecttemplate.create') }}">
                        ...
                        <td>
                            <form action="{{ route('lecttemplate.destroy',$templateform->id) }}" method="POST">
                                ...
                                @if ($templateform->lecturer_id == Auth::id())
                                    <a class="btn btn-info btn-sm rounded-btn" href="{{ route('lecttemplate.edit', $templateform->id) }}">
