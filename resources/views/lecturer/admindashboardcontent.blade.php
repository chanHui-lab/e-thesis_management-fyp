...
<main>
  ...
  <h1 class="d-inline-block ml-3">Dashboard</h1>
        ...
        <div class="card-deck">
            ...
            <div class="card ml-0">
                ...
                <div class="card-body mt-3 ml-3">
                    ...
                    <h5 class="card-title d-inline-block ml-3">Form</h5>
                    <p>Explore Form templates and its submission post</p>
                    <a href="{{ route('formtemplate.index') }}" class="btn btn-primary " style="background-color: #FACD3F; border:transparent">Explore</a>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-body mt-3 ml-3">
                    ...
                    <h5 class="card-title d-inline-block ml-3">Report</h5>
                ...
                <div class="card-body mt-3 ml-3">
                    <div class="d-grid align-items-start">
                        <div class="d-flex">
                            ...
                            <i class="fas fa-file-powerpoint" style="font-size: 20px; padding-top:5px;"></i>
                            <h5 class="card-title ml-3 mb-0" style="max-width: 150px; overflow: hidden; text-overflow: ellipsis;" title="Presentation slides">Presentation slides</h5>
                        </div>
              ...
              <div class="card-header" style=" background-color: rgb(255, 242, 198); border:transparent">
                <div class="row align-items-center">
                  ...
                  <div class="coltext-right">
                    <a href="{{ route('calendar.index') }}" class="btn btn-primary btn-common" style="background-color: #251d00; ">Edit Calendar</a>
                </div>
              </div>
                </div>
