...
<main>
<h1 style = "padding-top: 20px; padding-bottom:20px">Edit Form Submission Post </h1>

<a style = "margin-bottom: 20px;" class="btn btn-primary" href="{{ route('lectformpost.index') }}"> Back</a>
 {{--handle error  --}}
@if ($errors->any())
...
<div class="card card-primary">
    ...
    <!-- form start -->
      ...
      <form method="POST" action="{{ route('lectformpost.update', ['id' => $getRecord->id]) }}" enctype="multipart/form-data">
    ...
    $(document).ready(function () {
        ...
        $('.removeFileBtn').click(function () {
         ...
         $('#removeFileBtn').click(function () {
            ...
            $.ajax({
                url: '{{ route("lectformpost.remove-file", $getRecord->id) }}',
                type: 'DELETE',
                headers: {
