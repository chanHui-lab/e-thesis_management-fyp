...
<main>
    <div class="row">
        <div style = "padding-top: 20px;" class="col-lg-12">
            <a class="btn btn-primary back-button" href="{{ route('lectformpost.index') }}">Back</a>
              ...
              <div class="card">
                ...
                <div class="card-body">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ $formSubmission ? route('lectformpost.show', ['submissionPostId' => $submissionPost->id, 'formSubmissionId' => $formSubmission->id]) : '#' }}" class="btn btn-primary {{ !$formSubmission ? 'btn-disabled' : '' }}" @if (!$formSubmission) disabled @endif>
