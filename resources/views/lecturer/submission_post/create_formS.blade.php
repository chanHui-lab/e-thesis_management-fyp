...
{{-- TO CREATE  --}}
<main>
    <h1 style = "padding-top: 20px; padding-bottom:20px">Create Form Submission Post</h1>
    ...
    <a href="{{ route('lectformpost.index') }}" style = "margin-bottom:20px" class="btn btn-primary">Back</a>
