    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="float-right" style = "padding-bottom: 10px;">
                <a class="btn btn-success rounded-btn btn-common" href="{{ route('lectformpost.create') }}">
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="{{ route('lectformpost.destroy',$postform->id) }}" method="POST">
                                ...
                                {{-- @php
                                    $routeName = (auth()->user()->role_as == 0) ? 'lectformpost.showAllAdmin' : 'formpost.showAllLecturer';
                                @endphp --}}
                                {{-- <a href="{{ route($routeName, ['submissionPostId' => $submissionPostId]) }}">View Form Submissions</a> --}}

                                <a class="btn btn-primary btn-sm rounded-btn" href="{{ route('lectformpost.showAllLecturer', ['submissionPostId' => $postform->id]) }}">
                                ...
                                <a class="btn btn-info btn-sm rounded-btn" href="{{ route('lectformpost.edit',$postform->id) }}">
