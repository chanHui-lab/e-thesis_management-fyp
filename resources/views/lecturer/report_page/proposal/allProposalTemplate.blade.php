    ...
    <div class="row">
        <div class="col-lg-12">
            <div class=" titleforform">
                <h1><i style="font-size: 30px;margin-right:20px" class="fas fa-clipboard"></i>Proposal Templates</h1>
                <h5>(Total: {{ $template->count() }})</h5>
            </div>
            <div class="float-right">
                <a style="margin-bottom: 10px;" class="btn btn-success btn-common" href="{{ route('lectproptemplate.create') }}">
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">All Proposal Templates</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="{{ route('template.destroy',$templateform->id) }}" method="POST">
                             ...
                             <a class="btn btn-info btn-sm rounded-btn" href="{{ route('lectproptemplate.edit',$templateform->id) }}">
