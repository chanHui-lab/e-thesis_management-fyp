...
<main>
<h1 style = "padding-top: 20px; padding-bottom:20px">Edit Proposal Submission Post </h1>

<a style = "margin-bottom: 20px;" class="btn btn-primary" href="{{ route('proposalpost.index') }}"> Back</a>
 {{--handle error  --}}
@if ($errors->any())
