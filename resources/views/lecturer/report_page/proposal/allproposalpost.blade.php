        ...
        <div class="col-lg-12">
            <div class=" titleforform">
                ...
                <h1 style = "padding-top: 20px;">
                    ...
                    Proposal Submission Post</h1>
                <h6>(Total: {{ $post -> count() }})</h6>
            </div>
            <div class="float-right" style = "padding-bottom: 10px;">
                <a class="btn btn-success rounded-btn btn-common" href="{{ route('lectproposalpost.create') }}">
                    <i class="fa fa-upload" style="margin-right: 5px;"></i> Upload New Proposal Submission Post</a>
                ...
                <tr>
                    ...
                    <td>
                        <form action="{{ route('lectformpost.destroy',$postform->id) }}" method="POST">
                            ...
                            <a class="btn btn-primary btn-sm rounded-btn" href="{{ route('lectproposalpost.showAll', ['submissionPostId' => $postform->id]) }}">
                            ...
                            <a class="btn btn-info btn-sm rounded-btn" href="{{ route('lectproposalpost.edit',$postform->id) }}">
