                ...
                <div class="card-body">
                    ...
                    <tr>
                        ...
                        @php
                            ...
                            // }
                            // $formfiles = $proposalSubmissions ? json_decode($proposalSubmission->thesis_file, true) : null;
                        ...
                        <td>
                            ...
                            <a href="{{ $proposalSubmission ? route('lectproposalpost.show', ['submissionPostId' => $submissionPost->id, 'proposalSubmissionId' => $proposalSubmission->id]) : '#' }}" class="btn btn-primary {{ !$proposalSubmission ? 'btn-disabled grey-btn' : '' }}" @if (!$proposalSubmission) disabled @endif>
