...
{{-- TO CREATE  --}}
<main>
    <h1 style = "padding-top: 20px; padding-bottom:20px">Create Thesis Submission Post</h1>
    ...
    <a href="{{ route('lectthesispost.index') }}" style = "margin-bottom:20px" class="btn btn-primary">Back</a>
    ...
    <div class="card card-primary">
        ...
        <form method="post" action="{{ route('lectthesispost.store')}}" enctype="multipart/form-data">
