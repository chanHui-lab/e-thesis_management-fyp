        ...
        <div class="col-lg-12">
            <div class=" titleforform">
                ...
                <h1 style = "padding-top: 20px;">
                    ...
                    Thesis Submission Post</h1>
                <h6>(Total: {{ $post -> total() }})</h6>
            </div>
            <div class="float-right" style = "padding-bottom: 10px;">
                <a class="btn btn-success rounded-btn btn-common" href="{{ route('lectthesispost.create') }}">
                    <i class="fa fa-upload" style="margin-right: 5px;"></i> Upload New Thesis Submission Post</a>
        ...
        <div class="col-12" style="padding: 10px; float: right;">
            ...
            <div class="card-body">
                ...
                <tr>
                    ...
                    {{-- <td class="{{ $postform->remainingTime->invert === 1 ? "red-bg text-white" : "green-bg" }}">
                    ...
                    <td>
                        <form action="{{ route('lectthesispost.destroy',$postform->id) }}" method="POST">
                            ...
                            <a class="btn btn-primary btn-sm rounded-btn" href="{{ route('lectthesispost.showAll', ['submissionPostId' => $postform->id]) }}">
                            ...
                            <a class="btn btn-info btn-sm rounded-btn" href="{{ route('lectthesispost.edit',$postform->id) }}">
