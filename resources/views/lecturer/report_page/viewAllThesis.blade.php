...
<main>
    <div class="row">
        <div style = "padding-top: 20px;" class="col-lg-12">
            <a class="btn btn-primary back-button" href="{{ route('lectthesispost.index') }}">Back</a>
                ...
                <div class="card-body">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @else
                                {{-- {{ $submission->users->thesisSubmission->thesis_status }} --}}
                        ...
                        <td>
                            ...
                            <a href="{{ $thesisSubmission ? route('lectthesispost.show', ['submissionPostId' => $submissionPost->id, 'thesisSubmissionId' => $thesisSubmission->id]) : '#' }}" class="btn btn-primary {{ !$thesisSubmission ? 'btn-disabled  grey-btn' : '' }}" @if (!$thesisSubmission) disabled @endif>
