    ...
    <div class="row">
        <div class="col-lg-12">
            <div class=" titleforform">
                <h1><i style="font-size: 30px;margin-right:20px" class="fa fa-file-powerpoint"></i>Presentation Slide Templates</h1>
                <h5>(Total: {{ $template -> count() }})</h5>
            </div>
            <div class="float-right">
                <a style="margin-bottom: 10px;" class="btn btn-success btn-common" href="{{ route('lectslidestemplate.create') }}">
                    <i class="fa fa-upload iconie"></i>
                    Upload New PPT Template
                </a>
            </div>
        </div>
    </div>
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">All Presentation Slides Templates</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="{{ route('lecttemplate.destroy',$templateform->id) }}" method="POST">
                             ...
                             <a class="btn btn-info btn-sm rounded-btn" href="{{ route('lectslidestemplate.edit',$templateform->id) }}">
...
<script>
  $(function () {
    ...
    $("#example1").DataTable({
      ...
      columnDefs: [
            { width: '1%', targets: [0] }, // Adjust the width of the first column (index 0)
            { width: '5%', targets: [1] }, // Adjust the width of the first column (index 0)
            { width: '10%', targets: [2] },
            { width: '30%', targets: [3] },
            { width: '10%', targets: [4] }
        ]
