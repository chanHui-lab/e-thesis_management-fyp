...
<main>
<h1 style = "padding-top: 20px; padding-bottom:20px">Edit Presentation Slides Submission Post </h1>

<a style = "margin-bottom: 20px;" class="btn btn-primary" href="{{ route('lectproposalpost.index') }}"> Back</a>
 {{--handle error  --}}
@if ($errors->any())
