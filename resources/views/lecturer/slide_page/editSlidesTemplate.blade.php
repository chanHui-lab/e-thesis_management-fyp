...
<main>
<h1 style = "padding-top: 20px; padding-bottom:20px">Edit Presentation Slides Template</h1>
<div class="pull-right">
  <a class="btn btn-primary" href="{{ route('slidestemplate.index') }}" style = "margin-bottom:20px"> Back</a>
</div>
 {{--handle error  --}}
@if ($errors->any())
