...
<div class="submission-tab">
    {{-- <div class="tab-button"> --}}
        <a class="btn btn-primary back-button" href="{{ route('lectslidespost.showAll', ['submissionPostId' => $submissionPostId]) }}">Back</a>
    ...
    <div class="card">
        ...
        <div class="card-body custom-gray-box">
            <p><strong>Opened:</strong> {{ $slideSubmission->submissionPost->created_at }}</p>
            <p class="linee"><strong>Due:</strong> {{ $slideSubmission->submissionPost->submission_deadline }}</p>
            @php
                $files = json_decode($slideSubmission->submissionPost->files, true);
            @endphp
            <div class="arrow-box">
