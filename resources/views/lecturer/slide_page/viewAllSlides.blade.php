...
<main>
    <div class="row">
        <div style = "padding-top: 20px;" class="col-lg-12">
            <a class="btn btn-primary back-button" href="{{ route('lectproposalpost.index') }}">Back</a>
            ...
            <div class=" titleforform">
                ...
                <h6>(Total: {{ $slideSubmissions -> count() }})</h6>
            </div>
        </div>
    </div>
                ...
                <div class="card-body">
                    ...
                    <tr>
                        ...
                        @php
                            ...
                            // if ($slideSubmissions) {
                            //     $slideSubmission = $slideSubmissions->where('student_id', $submission->stu_id)->first();
                            // }
                            // $formfiles = $slideSubmissions ? json_decode($slideSubmission->thesis_file, true) : null;
                        ...
                        <a href="{{ $slideSubmission ? route('lectslidespost.show', ['submissionPostId' => $submissionPost->id, 'slideSubmissionId' => $slideSubmission->id]) : '#' }}" class="btn btn-primary {{ !$slideSubmission ? 'btn-disabled grey-button' : '' }}" @if (!$slideSubmission) disabled @endif>
