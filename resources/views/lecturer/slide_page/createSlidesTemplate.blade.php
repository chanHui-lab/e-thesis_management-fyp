...
<main>
<h1 style = "padding-top: 20px; padding-bottom:10px">Create Presentation Slides Template</h1>

<a href="{{ route('lectslidestemplate.index') }}" class="btn btn-primary" style = "margin-bottom:20px">Back</a>
...
<div class="card card-primary">
    ...
    <form method="post" action="{{ route('lecttemplate.store')}}" enctype="multipart/form-data">

        @csrf
        <div class="card-body">
        <input type="hidden" name="section" value="slide">
