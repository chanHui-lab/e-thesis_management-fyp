      ...
      <div class="card"  style="padding:0px; margin-left: -15px; margin-bottom:20px;">
        ...
        <div class="card-body">
          ...
          <div>
            ...
            @if ($template->lecturer_id == Auth::id())
        ...
        <div class="card card-primary">
          ...
          <div class = "card-body">
            <div id="external-drag">
              ...
              <div class="external-event" style="background-color: #FACD">FYP Final Proposal Presentation and Demo</div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content" style= "z-index:10000;">
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('lectcalendarsche.upload') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/moment-timezone/0.5.33/moment-timezone.min.js"></script>
  ...
  $(document).ready(function () {
      ...
      eventReceive: function(event) {
        ...
        $.ajax({
              url: '{{ route("lectcalendarsche.storedrag") }}',
              method: 'POST',
              data: {
                title: event.title,
    ...
    function changeEvent(event) {
      ...
      $.ajax({
          url: '/lecturer/calendar/updateEvent/' + updatedEvent.id,
          type: 'POST', // Adjust the HTTP method as needed
          data: updatedEvent,
          success: function (response) {
              console.log('Event updated successfully');
    ...
    function updateEventDatabase(event) {
        // Make an AJAX request to update the event in the database
        $.ajax({
            url: '/lecturer/calendar/updatedrag-event',
            type: 'POST',
            data: {
                id: event.id,
      ...
      if (event.extendedProps.type === 'presentation') {
        ...
        console.log("hereeee" + eventId);
          ...
          viewAllButton.on('click', function () {
            ...
            var viewAllUrl = '{{ route("lectformpost.showAllLecturer", ["submissionPostId" => ":eventId"]) }}';
  ...
  function deleteEvent(eventId) {
    ...
    // After successful deletion, you might want to update the UI or refresh the calendar
      $.ajax({
          url: '/lecturer/calendar/delete-event/'  + eventId,
          type: 'DELETE',
          success: function(response) {
  ...
  function updateEventList(clickedDate, info) {
    ...
    $.ajax({
          url: '/lecturer/calendar/events/' + formattedDate,
          method: 'GET',
          success: function (events) {

            console.log("in", JSON.stringify(events, null, 2));
    ...
    $('#saveEventChanges').on('click', function () {
      ...
      $.ajax({
          url: '/lecturer/calendar/update/' + selectedEventId, // Use the correct route URL
          // type: 'PUT',
          type: 'POST',
          // data: formData,
  ...
  function retrieveEventDetails(eventId) {
    ...
    $.ajax({
        method: 'GET',
        url: `/lecturer/calendar/${eventId}`, // Adjust the URL to match your Laravel route
        success: function (response) {
