...
class FormController extends Controller
{
    public function index()
    {
        ...
        return view('lecturer.template_page.admintemplateupload', compact('template'));
    }
    ...
    public function test2()
    {
        ...
        return view('lecturer.template_page.adminallthesissubmission');
    ...
    public function create()
    {
        ...
        return view('lecturer.template_page.createFormTemplate');
    ...
    public function store(Request $request){
        ...
        switch ($section) {
            case 'thesis':
                $redirectRoute = 'lectthesistemplate.index';
                $successMessage = 'Thesis Template created successfully';
                break;
            case 'form':
                $redirectRoute = 'lecttemplate.index';
                $successMessage = 'Form Template created successfully';
                break;
            case 'proposal':
                $redirectRoute = 'lectproptemplate.index';
                $successMessage = 'Proposal Template created successfully';
                break;
            case 'slide':
                $redirectRoute = 'lectslidestemplate.index';
                $successMessage = 'Slide Template created successfully';
                break;
            default:
                $redirectRoute = 'lectthesistemplate.index'; // Replace with your default route
    ...
    public function show($id)
    {
        ...
        return view('lecturer.template_page.adminshowformtemplate', compact('template','pdfUrl'));
    }
    ...
    public function edit( $id)
    {
        ...
        if(!empty($data['getRecord'])){
            return view('lecturer.template_page.admineditformtemplate',$data);
        }
        else{
            abort(404);
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('lecttemplate.index')->with('error', 'An error occurred while updating the FORM template');
    }
}
    ...
    public function destroy($id)
    {
        ...
        if (!$template) {
            return redirect()->route('lecttemplate.index')->with('error', 'Template not found');
        }
        $section = $template->section;
        $template->delete();
    ...
    public function indexPost()
    {
        ...
        if ($loggedInUser->role_as == 0) {
            ...
            return view('lecturer.submission_post.allformpost',compact('post'));
        }
        return view('lecturer.submission_post.allformpost',compact('post'));
    ...
    {
        return view('lecturer.submission_post.create_formS');
    }
    ...
    public function editPost($id)
    {
        ...
        if(!empty($data['getRecord'])){
            return view('lecturer.submission_post.edit_formS', $data);
        }
        else{
            return redirect()->route('formpost.index')->with('error', 'Submission post not found');
        }
    ...
    protected function validateFiles(array $files)
{
    ...
    public function TestgetFormSubmissionForLecturer($submissionPostId){
        ...
        // dd($formSubmissions);
        return view('lecturer.submission_post.viewAll', compact('formSubmissions','submissionPost'));
    }
    ...
    public function getFormSubmissionForLecturer($submissionPostId)
    {
        ...
        return view('lecturer.submission_post.viewAll', compact('formSubmissions', 'students', 'submissionPost'));
        }
    }
...

    {
        ...
        return view('lecturer.submission_post.viewOne', compact( 'formSubmission','submissionPostId', 'comments'));
    }
