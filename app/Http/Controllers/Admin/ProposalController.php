...
class ProposalController extends Controller
{
    ...
    {
        return view('admin.report_page.proposal.createProposalTemplate');
    ...
    public function edit( $id)
    {
        ...
        if(!empty($data['getRecord'])){
            return view('admin.report_page.proposal.editProposalTemplate',$data);
        }
        else{
            abort(404);
        }
    ...
    {
        return view('admin.report_page.proposal.create_proposalS');
    }
...

    {
        ...
        return view('admin.report_page.proposal.viewOneProposal', compact('proposalSubmission','submissionPostId', 'comments'));
    }
    ...
    public function editPost($id)
    {
        ...
        if(!empty($data['getRecord'])){
            // dd($data);
            return view('admin.report_page.proposal.editProposalF', $data);
        }
        else{
            return redirect()->route('proposalpost.index')->with('error', 'Submission post not found');
        }
    }
}
